...
public class VoiceFirebaseMessagingService extends FirebaseMessagingService {
    ...
    private void notify(CallInvite callInvite, int notificationId) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            String contentTitle = "twilio";//getString(incomingCallAppNameId);
    ...
    public Notification buildNotification(String text, PendingIntent pendingIntent, Bundle extras) {
      ...
      //Toast.makeText(getApplicationContext(),getResources().getIdentifier("INCOMING_CALL_APP_NAME", "string", getPackageName()),Toast.LENGTH_LONG).show();
